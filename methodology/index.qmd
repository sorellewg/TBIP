...
he model extends prior work by Vafa et al. (2020) and earlier iterations of Gaynor et al. (2026), which utilizes Latent Dirichlet Allocation (LDA) via Gibbs sampling to generate outputs based on topic-word distribution (β) and document topic distributions (θ). These estimates are then used to initialize the TBIP model.
{\mathrm{word\ rate}}_{i,k,v}={\underbrace{\eta_{k,v}}}\below{\mathrm{neutral\ baseline}}+x_i\cdot{\underbrace{\kappa_{k,v}}}\below{\mathrm{ideological\ polarity}}
